    ...
    <div class="text-center">
        <div class="image-container">
            ...
            <div class="text-overlay d-flex justify-content-between ">
                <p style="font-size: 40px;color: #1B378C;margin-bottom: 0px;font-weight: 400;" class="align-self-center underline-container d-flex align-items-center text-uppercase">
                    <?php echo $title; ?>
                </p>
