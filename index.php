...
<div id="carouselExampleFade" class="carousel slide carousel-fade mb-5">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="assets/images/home3.png" class="d-block w-100" alt="...">
        </div>
    </div>
...
<div class="container border-bottom container-padding index-margin" style="margin-top: 5rem;">
    <div class="row my-5 grid column-gap-6">
        ...
        <div class="col-12 col-lg-6">
            ...
            <p class="mb-3 text-uppercase" style="color: #1B378C;font-weight: 600;font-size: 26px;width: 50%;">Find and Book
                Your Dream</p>
            ...
            <div class="row ">
                <div class="d-flex justify-content-start mb-4">
                    <button type="button" id="submit-button" onclick="window.location.href='about-us.php';" class="btn rounded-none submit-button" style="padding: 15px 30px;">Read More <img src="assets/images/arrow-up-right.png" alt=""></button>
                </div>
            </div>
        </div>

    </div>
    <div class="row grid column-gap-6 index-margin">
        <div class=" col-md-6">
            ...
            <p class="mb-3 text-uppercase" style="color: #1B378C;font-weight: 600;font-size: 26px;width: 50%;">Know What You're Looking for? </p>
            <p>Universe Marine Myanmar Co.,Ltd has founded in 2005.</p>
            <div style="color: #595959;font-weight: 400;font-size: 17px;line-height: 30px;">
                <p>
            ...
            <div class="row ">
                <div class="d-flex justify-content-start mb-4">
                    <button type="button" id="submit-button" class="btn rounded-none submit-button"
    ...
    <div class="d-flex justify-content-center index-margin">
        <p class="mb-0" style="color: #0F9FBF;font-weight: 500;font-size: 20px;"><i class="fa-solid fa-anchor me-3 mb-3"></i>Service of Company</p>
    </div>
    <div class="row my-md-5 grid column-gap-6">
        <div class="col-md-4">
            <img
    ...
    <div class="d-flex justify-content-center mb-md-4">
        <button type="button" id="submit-button" class="btn rounded-none submit-button" style="padding: 15px 30px;">Read More <img src="assets/images/arrow-up-right.png" alt=""></button>
    </div>
</div>
